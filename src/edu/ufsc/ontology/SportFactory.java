...
public class SportFactory implements CodeGenerationFactory {
    ...
    {
        javaMapping.add("http://www.co-ode.org/ontologies/pizza/pizza.owl#Famous", Famous.class, DefaultFamous.class);
    }

    /**
     * Creates an instance of type Famous.  Modifies the underlying ontology.
     */
    public Famous createFamous(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_FAMOUS, DefaultFamous.class);
    }

    /**
     * Gets an instance of type Famous with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public Famous getFamous(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_FAMOUS, DefaultFamous.class);
    }

    /**
     * Gets all instances of Famous from the ontology.
     */
    public Collection<? extends Famous> getAllFamousInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_FAMOUS, DefaultFamous.class);
    }
    ...
    {
        javaMapping.add("urn:absolute:sport-ontology#CyclingFamous", CyclingFamous.class, DefaultCyclingFamous.class);
    }

    /**
     * Creates an instance of type CyclingFamous.  Modifies the underlying ontology.
     */
    public CyclingFamous createCyclingFamous(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_CYCLINGFAMOUS, DefaultCyclingFamous.class);
    }

    /**
     * Gets an instance of type CyclingFamous with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public CyclingFamous getCyclingFamous(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_CYCLINGFAMOUS, DefaultCyclingFamous.class);
    }

    /**
     * Gets all instances of CyclingFamous from the ontology.
     */
    public Collection<? extends CyclingFamous> getAllCyclingFamousInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_CYCLINGFAMOUS, DefaultCyclingFamous.class);
    }
    ...
    {
        javaMapping.add("urn:absolute:sport-ontology#SoccerFamous", SoccerFamous.class, DefaultSoccerFamous.class);
    }

    /**
     * Creates an instance of type SoccerFamous.  Modifies the underlying ontology.
     */
    public SoccerFamous createSoccerFamous(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_SOCCERFAMOUS, DefaultSoccerFamous.class);
    }

    /**
     * Gets an instance of type SoccerFamous with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public SoccerFamous getSoccerFamous(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_SOCCERFAMOUS, DefaultSoccerFamous.class);
    }

    /**
     * Gets all instances of SoccerFamous from the ontology.
     */
    public Collection<? extends SoccerFamous> getAllSoccerFamousInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_SOCCERFAMOUS, DefaultSoccerFamous.class);
    }
    ...
    {
        javaMapping.add("urn:absolute:sport-ontology#SwimFamous", SwimFamous.class, DefaultSwimFamous.class);
    }

    /**
     * Creates an instance of type SwimFamous.  Modifies the underlying ontology.
     */
    public SwimFamous createSwimFamous(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_SWIMFAMOUS, DefaultSwimFamous.class);
    }

    /**
     * Gets an instance of type SwimFamous with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public SwimFamous getSwimFamous(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_SWIMFAMOUS, DefaultSwimFamous.class);
    }

    /**
     * Gets all instances of SwimFamous from the ontology.
     */
    public Collection<? extends SwimFamous> getAllSwimFamousInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_SWIMFAMOUS, DefaultSwimFamous.class);
    }
    ...
    {
        javaMapping.add("urn:absolute:sport-ontology#TennisFamous", TennisFamous.class, DefaultTennisFamous.class);
    }

    /**
     * Creates an instance of type TennisFamous.  Modifies the underlying ontology.
     */
    public TennisFamous createTennisFamous(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_TENNISFAMOUS, DefaultTennisFamous.class);
    }

    /**
     * Gets an instance of type TennisFamous with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public TennisFamous getTennisFamous(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_TENNISFAMOUS, DefaultTennisFamous.class);
    }

    /**
     * Gets all instances of TennisFamous from the ontology.
     */
    public Collection<? extends TennisFamous> getAllTennisFamousInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_TENNISFAMOUS, DefaultTennisFamous.class);
    }
